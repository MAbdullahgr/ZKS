...
- Name: dashboard.spec.ts >> Dashboard — overview >> dashboard navigation to /inventory works
- Location: e2e\dashboard.spec.ts:72:7
...
Call log:
  - Expect "toHaveURL" with timeout 10000ms
    22 × unexpected value "http://localhost:3000/dashboard"
